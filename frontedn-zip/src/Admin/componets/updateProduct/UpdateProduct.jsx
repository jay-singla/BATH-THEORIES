        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6} sm={4}>
            <FormControl fullWidth>
              ...
              >
                <MenuItem value="Tops">Washbasens</MenuItem>
                <MenuItem value="Dresses">Toilet Seats</MenuItem>
                <MenuItem value="T-Shirts"> Foucets</MenuItem>
                <MenuItem value="Saree">Showers</MenuItem>
              </Select>
            </FormControl>
          </Grid>
          <Grid item xs={12}>
